...
while(True):
    Table = []
    for i in range(10):
        Table.append(input("entrer l element "))
    ...
    print("the new table between [",indece1,",",indece2,"] is ",souTableau(Table,indece1,indece2))
    
    if M("tu veux sortie le program? (y/Y ou n/N) pour remlire an nauveau list press n/N  "):
        break